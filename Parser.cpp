//Парсинг протоколов разнесён в разные функции с целью 
//оставить возможность лёгкого расширения 
//функционала по отдельности для каждого протокола
#include <iostream>
#include <cstring> 
#include <exception>
...
int main()
{
    ...
    std::string users_url;
    std::cin >> users_url;
    inGeneralURLs(users_url);
}
